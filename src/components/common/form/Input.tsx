    ...
    return (
      <div class={["input-field relative space-y-1", wrapperClasses]}>
        ...
        <input
          ...
          class={[
            "block h-9 w-full rounded-none border border-solid border-neutral-900 bg-white px-3 py-1.5 text-left align-middle text-base  normal-case leading-[1.42857] text-bimatoto-gold shadow-[rgba(0,0,0,0.075)_0_1px_1px_inset] placeholder:capitalize placeholder:text-bimatoto-gold focus:border-bimatoto-purple focus:shadow-[rgba(0,0,0,0.075)_0_1px_1px_inset,rgba(102,175,233,0.6)_0_0_8px] focus:outline-none",
            classes,
          ]}
        />
        {props.name == "password" && (
          <div
            class="absolute bottom-0.5 right-1 rounded bg-slate-500 text-white"
            onClick$={() => {
